...
([Download v.3 for Mac](https://github.com/LesserChance/samplepad-editor/releases/download/v0.3/samplepad-editor-0.3.0-mac.zip) or [Download v.3 for PC](https://github.com/LesserChance/samplepad-editor/releases/download/v0.3/samplepad-editor.Setup.0.3.0.exe))
