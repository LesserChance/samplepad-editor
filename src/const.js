...
export const KitBuffer = {
  ...
  PAD_FILE_ORDER: {
    [DeviceType.SAMPLEPAD_PRO]: [ // 8 pads, 2 external pads - whats all the other stuff?
      'snr_a', 'snr_b', 'tom1a', 'tom1b', 'tom2a', 'tom2b', 'tom3a', 'tom3b', 'cr1a', 'cr1b', 'cr2a', 'cr2b', 'ridea',
      'ride2', 'rideb', 'kick', 'hha_op'
    ],
    [DeviceType.SAMPLERACK]: [ // 24 possible pads
      'snr_a', 'snr_b', 'tom1a', 'tom1b', 'tom2a', 'tom2b', 'tom3a', 'tom3b', 'cr1a', 'cr1b', 'cr2a', 'cr2b', 'ridea',
